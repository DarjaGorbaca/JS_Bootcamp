...
function updateCustomer(
    ...
    $query = "UPDATE Customers SET firstname='$firstname',lastname='$lastname',email='$email', 
...
function createCustomer(
    ...
    $prepStament = $con->prepare("INSERT INTO Customers (firstname,lastname,email,phone) VALUES
    (?,?,?,?)");
